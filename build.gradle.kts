...
intellij {
    type.set("IU")
    version.set("IU-233.13135.103") // https://www.jetbrains.com/de-de/idea/download/other.html
    ...
    plugins.add("com.jetbrains.php:233.13135.108") // https://plugins.jetbrains.com/plugin/6610-php/versions
    ...
    plugins.add("org.jetbrains.plugins.phpstorm-docker:233.13135.67") // https://plugins.jetbrains.com/plugin/8595-php-docker/versions
}
